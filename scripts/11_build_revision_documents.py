...
("Subset and influential-sample analyses", "PCA and t-SNE were recomputed independently after excluding MMC, excluding controls, restricting to the in-house data, IBM versus non-IBM IIM, NOS, and ALS versus non-ALS NMA. Individual-sample influence was quantified for the two clinically relevant contrasts. ALS-NMA remains unstable and is now explicitly exploratory."),
