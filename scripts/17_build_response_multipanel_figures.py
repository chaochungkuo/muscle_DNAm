...
def main() -> None:
    ...
    build_figure(
        ...
        [
            ...
            panel("C", "PCA_scaled_PC1_PC3", "Scaled PC1–PC3", "Checks whether structure persists with PC3."),
            panel("D", "PCA_scaled_PC2_PC3", "Scaled PC2–PC3", "Checks secondary PCA structure."),
            panel("E", "PCA_unscaled_PC1_PC2", "Unscaled PC1–PC2", "Sensitivity without unit-variance scaling."),
            panel("F", "PCA_unscaled_PC1_PC3", "Unscaled PC1–PC3", "Unscaled PCA including PC3."),
            panel("G", "PCA_unscaled_PC2_PC3", "Unscaled PC2–PC3", "Unscaled secondary PCA structure."),
        ],
        ncols=2,
    )
    build_figure(
