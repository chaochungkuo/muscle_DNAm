...
""",
        """
Methods: explicitly state Rtsne parameters, including pca=TRUE and initial_dims=50 for the baseline analysis. Results: add one sentence that sensitivity analyses reproduced the major separation pattern across parameter settings, while exact t-SNE geometry varied. Discussion: avoid quantitative interpretation of t-SNE distances.
""",
        [
            (
