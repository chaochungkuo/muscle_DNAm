...
""",
    ...
    add_reviewer_comment(
        doc,
        """
The reviewer states that the study addresses an important question and that genome-wide methylation analysis in inflammatory, neurogenic and inherited muscle disorders is novel and potentially valuable.
""",
    )
    add_response(
        doc,
