---
title: "Quality Control of 240814_Popzhelyazkova_Bremer_Neuropathologie_DNAmArray"
author:
  Joseph Kuo
...
Tag_this_analysis <- "DNAmArray_QC"
PATH_IDAT <- "../../data/idats"
...
targets <- read.metharray.sheet(metadata_dir,
...
targets$ID <- targets$Sample.Name
...
save(targets, mSetSq, detP, file = file.path(output_dir, paste0(Tag_this_analysis, ".RData")))
```
