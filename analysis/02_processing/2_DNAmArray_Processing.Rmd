---
title: "Processing of 240814_Popzhelyazkova_Bremer_Neuropathologie_DNAmArray"
author:
  Joseph Kuo
...
Tag_this_analysis <- "DNAmArray_Processing"
output_dir <- "../../output"
...
pca_plot_3d <- plot_ly(df_pca_3d, x = ~PC1, y = ~PC2, z = ~PC3, type = 'scatter3d', mode = 'markers',
              color = ~Group, colors = pal, marker = list(size = marker_size)) %>%
...
## Filtered PCA (Principal Component Analysis)
...
## Filtered MDS (Multidimensional Scaling))
...
write.csv(bVals, file = file.path(output_dir, "processed_bVals.csv"))
write.csv(mVals, file = file.path(output_dir, "processed_mVals.csv"))
# Save the objects to a file
save(targets, bVals, mVals, file = file.path(output_dir, paste0(Tag_this_analysis, ".RData")))
```
