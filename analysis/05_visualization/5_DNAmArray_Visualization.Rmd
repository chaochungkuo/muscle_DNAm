---
title: "Visualization of 240814_Popzhelyazkova_Bremer_Neuropathologie_DNAmArray"
author:
  Joseph Kuo
...
Tag_this_analysis <- "DNAmArray_Visualization"
...
```{r, echo=TRUE, results='asis', warning=FALSE, message=FALSE, fig.height=8, fig.width=6, dpi=600}
viz_a_gene(genes_of_interest="ACSF2", extend_size=2000)
```

```{r, echo=TRUE, results='asis', warning=FALSE, message=FALSE, fig.height=8, fig.width=6, dpi=600}
viz_a_gene(genes_of_interest="HDGFRP2", extend_size=2000)
```

```{r, echo=TRUE, results='asis', warning=FALSE, message=FALSE, fig.height=8, fig.width=6, dpi=600}
viz_a_gene(genes_of_interest="ZFP91", extend_size=2000)
```
